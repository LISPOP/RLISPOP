...
1+'1'
```
To be honest, I don't know what a binary operator is. But look at the term, 'non-numeric'. That sounds a lot like what we learned about in terms of data types. If we look closely we see that one of the parts of the equation is actually *non-numeric*; it has single-quotes around it meaning that it is going to be treated as a character. Remove those single quotes:
...
I have created an error-riddled file in the RScript "find_errors_debug.R"  There are *five* errors in the file. Go through and try to fix each of the five errors.
